        ...
        success: function(answer) {
          ...
          if(isset(cfg.notify) && !/none/i.test(cfg.notify)) {
             ...
             if(/textbox/i.test(cfg.notify)) {
                 ...
                 $(vars.form).find('input[type=text]:visible, textarea:visible, select:visible').css({'border': '1px solid #fdcf17', 'color': 'inherit'}, 300);
                 if(isset(answer.errors)) {
                     $.each(answer.errors, function(k,val) {
                         var reg = /[a-z]/i;
                         if(reg.test(k)) {
                     ...
                     /* setInterval(function(){
					  ...
					  $('.formaFirst,.formaSecond').trigger('to.owl.carousel', [0]);
                  }
